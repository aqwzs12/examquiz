...
use Drupal\examquiz\Entity\ExamEntityType;


/**
 * Provides dynamic permissions for Exam entity of different types.
 *
 * @ingroup examquiz
 *
 */
class ExamEntityPermissions{
   ...
   *
   * @return array
   *   The ExamEntity by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (ExamEntityType::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\examquiz\Entity\ExamEntityType $type
   *   The ExamEntity type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(ExamEntityType $type) {
    $type_id = $type->id();
