...
use Drupal\examquiz\Entity\QuestionEntityType;


/**
 * Provides dynamic permissions for Question entity of different types.
 *
 * @ingroup examquiz
 *
 */
class QuestionEntityPermissions{
   ...
   *
   * @return array
   *   The QuestionEntity by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (QuestionEntityType::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\examquiz\Entity\QuestionEntityType $type
   *   The QuestionEntity type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(QuestionEntityType $type) {
    $type_id = $type->id();
